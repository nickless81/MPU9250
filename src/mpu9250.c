...
{
    /** TBD: Change this for nRF52 SDK equivalent
...
void     MPU9250_readMagData     (int16_t * destination)
{
    ...
    if(MPU9250_readByte(AK8963_ADDRESS, AK8963_ST1) & 0x01)
    {
      // Read the six raw data and ST2 registers sequentially into data array
      MPU9250_readBytes(AK8963_ADDRESS, AK8963_XOUT_L, 7, &rawData[0]);
...
/**
 * @brief MPU9250_updateTime
 */
void     MPU9250_updateTime()
{
    //TBD
}
/**
 ...
 * @param mz
 */
void    MPU9250_MadgwickQuaternionUpdate(
            float ax,
            float ay,
            float az,
            float gx,
...
void    MPU9250_MahonyQuaternionUpdate(
            float ax,
            float ay,
            float az,
            float gx,
